// From: https://github.com/jakobhellermann/bevy-inspector-egui/blob/main/crates/bevy-inspector-egui/examples/integrations/egui_dock.rs
// Edited to drop all 3D parts and spawn a 2D camera instead
...
fn setup(
    ...
    let color = Color::hsl(180.0, 0.95, 0.7);
