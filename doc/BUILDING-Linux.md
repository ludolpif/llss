...
gcc -g -Wall -Wformat -O0  `./cflags`  -Wl,-Bsymbolic -L../third-party/ui  alloc.o app-event.o app-init.o app-iterate.o main.o mod-host.o ui-main.o ../third-party/static/ecs/flecs.o -ldcimgui -lm -lstdc++ -lSDL3 -o ../app
