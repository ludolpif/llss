...
git submodule add -b for-llss-main --name dear_bindings https://github.com/ludolpif/dear_bindings.git third-party/ui/dear_bindings
git submodule add -b for-llss-main --name dear_imgui https://github.com/ludolpif/dear_imgui.git third-party/ui/imgui
...
mkdir -p third-party/graphics/SDL3
touch third-party/graphics/SDL3/.gitkeep
