...
# third-party/{static,shared,module} are names inspired by https://cmake.org/cmake/help/latest/command/add_library.html

mkdir -p third-party/static/ui
...
git submodule add -b for-llss-main --name dear_bindings https://github.com/ludolpif/dear_bindings.git third-party/static/ui/dear_bindings
git submodule add -b for-llss-main --name dear_imgui https://github.com/ludolpif/dear_imgui.git third-party/static/ui/imgui
...
mkdir -p third-party/shared/graphics/SDL3
touch third-party/shared/graphics/SDL3/.gitkeep
